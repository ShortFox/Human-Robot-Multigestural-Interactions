namespace MQ.MultiAgent
{
    ...
    public class PolhemusStream : MonoBehaviour
    {
        // port used for our UDP connection
        private int port = 5123;

        // tracker descriptors
        [SerializeField] private PolTracker tracker_type = PolTracker.G4;
        [SerializeField] private int max_systems = 1;
        [SerializeField] private int max_sensors = 2;

        // slots used to store tracker output data
        protected bool[] active;
        protected uint[] digio;
        protected Vector3[] positions;
        protected Vector4[] orientations;
