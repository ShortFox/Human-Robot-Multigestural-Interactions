...
namespace Tobii.Research.Unity
{
    internal static class VRUtility
    {
        ...
        internal static Transform GetEyeTrackerOrigin(GameObject cam)
        {
            ...
            // This should work to make sure the historical eye tracker origin is instantiated in the same scene as
            // the camera.
            historicalEyeTrackerOriginObject.transform.parent = cam.transform;
            historicalEyeTrackerOriginObject.transform.parent = null;
